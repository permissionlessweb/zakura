...
mod tests {
    ...
    fn transaction_hashes_and_auth_data_root_matches_separate_computation() {
        ...
        let block = zakura_test::vectors::BLOCK_MAINNET_1687107_BYTES
...
pub enum ReadRequest {
    ...
    ///
    /// Returns an [`Amount`](zakura_chain::amount::Amount) with the total
    ...
    /// [`zakura-state::GetBlockTemplateChainInfo`](zakura-state::GetBlockTemplateChainInfo)` structure containing
